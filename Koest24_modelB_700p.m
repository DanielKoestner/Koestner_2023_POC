...
% based on global dataset described in Koestner et al. 2024.
...
function [POC,PI,comp]=Koest24_modelB_700p(bbp,chla,alignment,bias,alpha)
...
mse=0.030834754177077; % mean square error from regression model, corrected 20260108
